...
@pytest.mark.parametrize(
    ...
    [
        ...
        (list[int] | int, NA, 2, True),
        (int | list[int], NA, 2.0, False),
        (list[int] | int, NA, 2.0, False),
        (int | list[int], NA, [1, 2], True),
        (list[int] | int, NA, [1, 2], True),
        (int | list[int], NA, [1, 2.0], False),
        (list[int] | int, NA, [1, 2.0], False),
        (BN1 | list[BN1], NA, OBN1, True),
        (BN1 | list[BN1], NA, [OBN1, OBN1], True),
        (list[BN1 | BN2], NA, [OBN1], True),
        (list[BN1 | BN2], NA, [OBN2], True),
        (list[BN1 | BN2], NA, [OBN3], False),
        (list[BN1 | BN2], NA, [OBN1, OBN1], True),
        (list[BN1 | BN2], NA, [OBN1, OBN2], True),
        (list[BN1 | BN2], NA, [OBN1, OBN3], False),
        (list[BN1 | BN2], NA, [OBN2, OBN1], True),
        (list[BN1 | BN2], NA, [OBN2, OBN3], False),
        (list[BN1 | BN2], NA, [OBN2, OBN2], True),
    ],
)
