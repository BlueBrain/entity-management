...
def test_resolve_context(monkeypatch, context_neuroshapes_resp, context_bbp_neuroshapes_resp):
...
def test_get_resolved_context(monkeypatch, context_neuroshapes_resp, context_bbp_neuroshapes_resp):
...
def test_get_resolved_context__cycle(
