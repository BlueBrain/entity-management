...
morphology_index = ModelReleaseIndex.from_name(morphology_index_name)
if morphology_index is None:
    ...
    morphology_index = morphology_index.publish()
# else:
...
if circuit_cell_properties is None:
    ...
    circuit_cell_properties = circuit_cell_properties.publish()


emodel_index_name = 'thalamus emodel release index'
emodel_index = ModelReleaseIndex.from_name(emodel_index_name)
...
memodel_index = ModelReleaseIndex.from_name(memodel_index_name)
if memodel_index is None:
    memodel_index = ModelReleaseIndex(name=memodel_index_name,
                                      distribution=Distribution(
                                          ...
                                          mediaType='text/plain'))
    memodel_index = memodel_index.publish()
...
if memodel_release is None:
    ...
    memodel_release = memodel_release.publish()
...
if synapse_release is None:
    synapse_release = SynapseRelease(
            ...
            distribution=Distribution(
                ...
                mediaType='text/plain'))
    synapse_release = synapse_release.publish()


edge_population_name = 'thalamus edge population1'
edge_population = ModelReleaseIndex.from_name(edge_population_name)
if edge_population is None:
    ...
    edge_population = edge_population.publish()
...
if edge_collection is None:
    ...
    edge_collection = edge_collection.publish()
...
if node_collection is None:
    ...
    node_collection = node_collection.publish()
