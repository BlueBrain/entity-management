BASE=https://bbp-nexus.epfl.ch/staging
...
http PUT $BASE/v0/schemas/neurosciencegraph/commons/modelinstance/v0.1.1 'Accept:application/ld+json' < modules/commons/target/exported/neurosciencegraph/commons/modelinstance/v0.1.1.json
http PATCH $BASE/v0/schemas/neurosciencegraph/commons/modelinstance/v0.1.1/config rev==1 published:=true 'Accept:application/ld+json'
...
http PUT $BASE/v0/schemas/neurosciencegraph/simulation/subcellularmodelscript/v0.1.0 'Accept:application/ld+json' < modules/simulation/target/exported/neurosciencegraph/simulation/subcellularmodelscript/v0.1.0.json
http PATCH $BASE/v0/schemas/neurosciencegraph/simulation/subcellularmodelscript/v0.1.0/config rev==1 published:=true 'Accept:application/ld+json'

http PUT $BASE/v0/schemas/neurosciencegraph/simulation/subcellularmodel/v0.1.1 'Accept:application/ld+json' < modules/simulation/target/exported/neurosciencegraph/simulation/subcellularmodel/v0.1.1.json
http PATCH $BASE/v0/schemas/neurosciencegraph/simulation/subcellularmodel/v0.1.1/config rev==1 published:=true 'Accept:application/ld+json'

http PUT $BASE/v0/schemas/neurosciencegraph/simulation/emodel/v0.1.1 'Accept:application/ld+json' < modules/simulation/target/exported/neurosciencegraph/simulation/emodel/v0.1.1.json
http PATCH $BASE/v0/schemas/neurosciencegraph/simulation/emodel/v0.1.1/config rev==1 published:=true 'Accept:application/ld+json'
...
http PUT $BASE/v0/schemas/neurosciencegraph/simulation/morphology/v0.1.1 'Accept:application/ld+json' < modules/simulation/target/exported/neurosciencegraph/simulation/morphology/v0.1.1.json
http PATCH $BASE/v0/schemas/neurosciencegraph/simulation/morphology/v0.1.1/config rev==1 published:=true 'Accept:application/ld+json'

http PUT $BASE/v0/schemas/neurosciencegraph/simulation/memodel/v0.1.1 'Accept:application/ld+json' < modules/simulation/target/exported/neurosciencegraph/simulation/memodel/v0.1.1.json
http PATCH $BASE/v0/schemas/neurosciencegraph/simulation/memodel/v0.1.1/config rev==1 published:=true 'Accept:application/ld+json'
