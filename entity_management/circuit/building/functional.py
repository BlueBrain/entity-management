...
class Sample:
    ...
    target: typing.Optional[str] = None  #: Sample target
...
class EstimateSynsCon(Strategy):
    ...
    sample: typing.Optional[typing.Union[Sample, Path]] = None
...
class EstimateBoutonReduction(Strategy):
    ...
    bio_data: typing.Union[Path, float]
    #: Parameters for sampling bouton density OR path to bouton-density dataset already sampled
    sample: typing.Optional[typing.Union[Sample, Path]] = None
...
class Recipe:
    ...
    strategies: typing.List[typing.Union[EstimateSynsCon,
                                         ExperimentalSynsCon,
    ...
    def asdict(self):
        ...
        return [{_cls_name_to_snake_case(type(strategy)):
                 attr.asdict(strategy, filter=_filter, value_serializer=_serializer)}
